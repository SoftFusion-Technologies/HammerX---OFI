        ...
        <div className="w-11/12 mx-auto pb-10" id="card-container">
          <div className="card">
            <div className="card1 max-md:max-w-full">
              <p>VISIÓN</p>
              <p className="small">
                Buscamos transformar el concepto tradicional de un gimnasio y convertirlo en 
                un lugar donde no solo se entrena y mejorar la salud física,
                sino también demostrar que puede ser un lugar donde se la pasa bien, se viven y
                se experimentan sensaciones positivas. De esta manera aspiramos a combatir el
                sedentarismo, involucrando a cada vez más personas dentro de este estilo de vida.
              </p>
          ...
          <div className="card flex justify-end">
            <div className="card1 right-bg max-md:max-w-full">
              <p>MISIÓN</p>
              <p className="small">
                HAMMER es un centro social de entrenamiento y entretenimiento que brinda
                calidad en su servicio. Somos un lugar donde las personas hacen ejercicio,
                pero también encuentran un momento para pasarla bien, divertirse, generar vínculos
                y sentirse acompañados, mostrando una manera diferente de hacerlo, así las ayudamos a incorporar la 
                actividad física como parte de su vida y porque no, a que se convierta en el momento que esperan de su día.
              </p>
              <div className="go-corner" href="#">
                <div className="go-arrow">🤫</div>
              </div>
          ...
          <div className="card">
            <div className="card1 max-md:max-w-full">
              ...
              <p className="small">
                ...
                instructores y coaches capacitados, por lo que no tenés que
                ...
                objetivos y respete a los demás es bienvenido. Aquí no juzgamos

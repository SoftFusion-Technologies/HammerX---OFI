        ...
        <div className="h-contain w-5/6 mx-auto">
          <div className="pt-20 max-sm:pt-16 flex justify-center gap-4 flex-wrap">
            ...
            <div className="flex justify-center gap-4 max-sm:flex-col md:space-x-5">
              ...
              </button>
              {
                ...
                showModal === 'entrenador' && (
                  ...
                  <ModalEntrenador anterior={entrenadorAnt} siguiente={entrenadorSig} /> 
                )
              }
              {
                showModal === 'promociones' && (
                  <ModalPromociones anterior={promocionesAnt} siguiente={promocionesSig}  />
                )
              }
            </div>
            ...
            <div className="flex justify-center gap-4 mt-4 max-sm:mt-0 sm:flex-wrap max-sm:flex-col md:space-x-5">
              ...
              {
                showModal === 'contratos' && (
                  <ModalContratos anterior={contratosAnt} siguiente={contratosSig}  />
                )
              }
              <button
                onClick={convenios}
              ...
              {
                showModal === 'convenios' && (
                  <ModalConvenios anterior={conveniosAnt} siguiente={conveniosSig}  />
                )
              }
              <button
              ...
              </button>
              {
                showModal === 'transferencia' && (
                  <ModalTransferencia anterior={transfeAnt} siguiente={transfeSig}  />
                )
              }
            </div>
          </div>
